<template>
  <div class="bg-white rounded-lg shadow-md p-6">
    ...
    <!-- 空状态 -->
    <div v-else-if="!result || result.length === 0" class="text-center text-gray-400 py-12">
    ...
    <div v-else class="space-y-4">
      ...
      <!-- 生成完成提示 -->
      <div v-if="!isLoading" class="flex items-center text-green-600 text-sm pt-4 border-t">
